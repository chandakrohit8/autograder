...
<body>
    ...
    <div class="container">
        <h2>Teacher Login</h2>
        <form action="" method="POST" id="teacherLoginForm">
            <div class="form-group">
                <label for="teacher_username">Username:</label>
                <input type="text" id="teacher_username" name="teacher_username">
            </div>
            ...
            <div class="register-div">
                <input type="submit" value="Login" onclick="setTeacherFormAction('teacher_dashboard.php')">
                <input type="submit" value="Register" onclick="setTeacherFormAction('register.php')">
            </div>
        </form>
        ...
        <form action="" method="POST" id="studentLoginForm">
            ...
            <div class="register-div">
                <input type="submit" value="Login" onclick="setStudentFormAction('student_dashboard.php')">
                <input type="submit" value="Register" onclick="setStudentFormAction('register.php')">
            </div>
        </form>
    </div>

    <script>
        function setTeacherFormAction(action) {
            document.getElementById('teacherLoginForm').action = action;
        }

        function setStudentFormAction(action) {
            document.getElementById('studentLoginForm').action = action;
        }
    </script>
</body>
</html>